...
(cl:defmethod cl:initialize-instance :after ((m <WordCount-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WordCount-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name agvworkspace-srv:<WordCount-request> is deprecated: use agvworkspace-srv:WordCount-request instead.")))

(cl:ensure-generic-function 'words-val :lambda-list '(m))
(cl:defmethod words-val ((m <WordCount-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agvworkspace-srv:words-val is deprecated.  Use agvworkspace-srv:words instead.")
  (words m))
...
(cl:defmethod cl:initialize-instance :after ((m <WordCount-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WordCount-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name agvworkspace-srv:<WordCount-response> is deprecated: use agvworkspace-srv:WordCount-response instead.")))

(cl:ensure-generic-function 'count-val :lambda-list '(m))
(cl:defmethod count-val ((m <WordCount-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agvworkspace-srv:count-val is deprecated.  Use agvworkspace-srv:count instead.")
  (count m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WordCount-response>)))
  ...
  "agvworkspace/WordCountResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WordCount-response)))
  "Returns string type for a service object of type 'WordCount-response"
  "agvworkspace/WordCountResponse")
