...
(cl:in-package agvworkspace-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <AgvNav-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AgvNav-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name agvworkspace-srv:<AgvNav-request> is deprecated: use agvworkspace-srv:AgvNav-request instead.")))

(cl:ensure-generic-function 'coordinate-val :lambda-list '(m))
(cl:defmethod coordinate-val ((m <AgvNav-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agvworkspace-srv:coordinate-val is deprecated.  Use agvworkspace-srv:coordinate instead.")
  (coordinate m))
...
(cl:defmethod cl:initialize-instance :after ((m <AgvNav-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AgvNav-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name agvworkspace-srv:<AgvNav-response> is deprecated: use agvworkspace-srv:AgvNav-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <AgvNav-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agvworkspace-srv:status-val is deprecated.  Use agvworkspace-srv:status instead.")
  (status m))

(cl:ensure-generic-function 'error_msg-val :lambda-list '(m))
(cl:defmethod error_msg-val ((m <AgvNav-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader agvworkspace-srv:error_msg-val is deprecated.  Use agvworkspace-srv:error_msg instead.")
  (error_msg m))
